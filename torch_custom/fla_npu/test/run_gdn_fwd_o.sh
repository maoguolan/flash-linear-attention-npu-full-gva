...
python3 test_fwd_o.py $batch $seqlen $kNumHead $vNumHead $kHeadDim $vHeadDim $isVariedLen $tokenBatch $chunkSize $scale "$dtype" $useActualInput $useActualOutput $dataPath $device $gDtype
